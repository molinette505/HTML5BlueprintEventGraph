export const globalNodes = [
    ...
    },
    {
        ...
        "category": "Flow Control",
        "color": "var(--header-default)",
        "functionId": "Flow.ForLoop",
        "inputs": [
            { "name": "Exec", "type": "exec" },
            { "name": "First Index", "type": "int", "default": 0 },
            { "name": "Last Index", "type": "int", "default": 0 }
        ],
        "outputs": [
    ...
    },
    {
        ...
        "category": "Math",
        "color": "var(--n-pure)",
        "functionId": "Math.RandomFloatInRange",
        "inputs": [
    ...
    },
    {
        ...
        "category": "Math",
        "color": "var(--n-pure)",
        "functionId": "Math.RandomIntInRange",
        "inputs": [
    ...
    },
    {
        ...
        "color": "var(--n-pure)",
        "hideHeader": true,
        "functionId": "Logic.StrictNotEqual",
        "centerLabel": "!==",
        "inputs": [
            { "name": "A", "type": "wildcard", "allowedTypes": ["float", "int", "string", "boolean", "vector", "class", "object", "transform"] },
            { "name": "B", "type": "wildcard", "allowedTypes": ["float", "int", "string", "boolean", "vector", "class", "object", "transform"] }
...
window.globalNodes = globalNodes;
